 ...
 * https://github.com/MIT-LCP/mimic-code/blob/master/notebooks/aline-aws/concepts/durations/ventilation-settings-awsathena.sql
 * 
...
where ce.value <> ''
	...
	and ce.hadm_id in (select hadm_id from hadm_overview)
...
where itemid in
	...
	and hadm_id in (select hadm_id from hadm_overview);